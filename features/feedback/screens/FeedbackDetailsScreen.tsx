...
import { getFeedbackTicket } from "@/features/feedback/api";
import FeedbackCard from "@/features/feedback/components/FeedbackCard";
import FeedbackComment from "@/features/feedback/components/FeedbackComment";
import FeedbackTypeBubble from "@/features/feedback/components/FeedbackTypeBubble";
import type { FeedbackTicketComment } from "@/features/feedback/types";
      ...
      <View>
        ...
        <View>
          {feedbackTicket?.comments && feedbackTicket?.comments.length > 0 ? (
            feedbackTicket?.comments.map((comment: FeedbackTicketComment) => {
