...
type Props = {
  ...
  ) => Promise<InfiniteQueryObserverResult<InfiniteData<ListFollowRequestsResponse, unknown>, Error>>;
};
  ...
  if (isFetchNextPageError) {
    return (
      <RetryFetchFooter
        ...
        message="Oh no! There was an error fetching more received follow requests!"
        buttonText="Retry"
      />
    );
  }
