...
const OnboardingMainScreen = () => {
  ...
  const progressStepsStyle = {
    ...
    activeLabelColor: isDarkMode ? COLORS.sky[400] : COLORS.sky[500],
    ...
    completedLabelColor: isDarkMode ? COLORS.zinc[600] : COLORS.zinc[300],
    labelColor: isDarkMode ? COLORS.zinc[500] : COLORS.zinc[700],
    disabledStepNumColor: isDarkMode ? COLORS.zinc[500] : COLORS.zinc[500],
    disabledStepIconColor: isDarkMode ? COLORS.zinc[800] : COLORS.zinc[500],
    progressBarColor: isDarkMode ? COLORS.zinc[500] : COLORS.zinc[500],
    labelSize: 14,
    topOffset: 8,
    marginBottom: 20,
    labelFontSize: 13,
